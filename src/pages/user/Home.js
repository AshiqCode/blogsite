...
export default function Home() {
  ...
  // ✅ assume TOOLS exists/imported elsewhere in your project
  ...
  return (
    ...
    >
      ...
      {/* ✅ Mobile responsive overrides (no desktop style change) */}
      <style>{`
        @media (max-width: 768px) {
          .ts-navbar { padding: 10px 14px !important; }
          .ts-nav-links {
            gap: 14px !important;
          ...
          .ts-logo { font-size: 18px !important; }
          .ts-top-spacer { margin-top: 64px !important; }
          .ts-about-wrap { padding-left: 16px !important; padding-right: 16px !important; }
          .ts-about-text { width: 100% !important; }
          .ts-privacy-wrap { padding: 16px !important; }
        }
      ...
      <>
        ...
        >
          ...
          <div
            className="ts-nav-links"
            style={{ display: "flex", gap: "50px", marginRight: "60px" }}
          >
            <div
        ...
        <div className="ts-top-spacer" style={{ marginTop: "70px" }} />
      </>
      ...
      <section style={{ padding: "20px" }}>
        <div style={{ maxWidth: 1200, margin: "0 auto" }}>
          ...
          <footer style={{ marginTop: 50 }}>
            ...
            >
              <h2 style={{ color: "#414b5f", fontSize: 18 }}>Privacy Policy</h2>

              <div style={{ color: "#4b5563" }}>
                <h3 style={{ color: "#414b5f", fontSize: 14 }}>
                  1. Information We Collect
                </h3>
                <p style={{ color: "#414b5f", fontSize: 12 }}>
                  we collect data to improve user experience in our website,
                  this includes cookies and data usage to understand which
                  category of ai tool you like more.
                </p>

                <h3 style={{ color: "#414b5f", fontSize: 14 }}>2. Cookies</h3>
                <p style={{ color: "#414b5f", fontSize: 12 }}>
                  store Cookies as you experience in our website it save your
                  experience and way of usage in which way you use our website
                  it also help in your user experience
                </p>
